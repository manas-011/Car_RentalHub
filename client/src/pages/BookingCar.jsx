...
function BookingCar() {
  ...
  function onChange(dates, dateStrings) {
    ...
    setFrom(dateStrings[0]) ; setTo(dateStrings[1]) ;
         ...
         {from && to && (
          ...
          <div>
              ...
              <StripeCheckout
                ...
                stripeKey="pk_test_51NHOozSD4ucIx9MSHNGyAmdeVRLmeB3eoL6d1QX9SQBWGB6ne0q1l3CRDv0mjLePBHIdaf1cCvASPGIh9cvwUKGQ004LiAOaEi"
              >
